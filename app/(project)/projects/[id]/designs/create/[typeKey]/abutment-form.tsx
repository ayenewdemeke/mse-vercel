...
interface Props {
  projectId: string;
  typeName: string;
  // Edit mode: pass designId + designName + data; action signature is (designId, projectId, fd)
  // Create mode: omit designId; action signature is (projectId, fd)
  designId?: string;
...
export default function AbutmentForm({
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <Card title="Design Name">
          <div className="max-w-sm">
            ...
            <Input
              ...
              placeholder="e.g. West Abutment MSE Wall"
        ...
        <Card title="Inextensible Reinforcement — Steel Strip">
          <Grid cols={3}>
            ...
            <Field name="f2" label="f2" data={data} />
